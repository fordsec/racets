...
\racets: an extension of Racket to faceted execution a library of
macros. Given Racket's highly-expressive macro system, our
implementation follows relatively directly from the semantics of
faceted execution. To demonstrate how \racets can be used for
policy-agnostic programming, we use it to build a web-based game of
Battleship. Our implementation sheds light on several interesting
issues in interacting with code written without faceted execution. Our
\racets implementation is open source, under development, and
available online.
\end{abstract}
