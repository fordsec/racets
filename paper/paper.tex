      ...
      \begin{array}{c}
        ...
        \begin{array}{cccc}
          ...
          \inferrule[\textsc{Lambda}]{ }
                    ...
                    &
          \inferrule[\textsc{Apply}]{e_1, \rho, \sigma \Downarrow_{pc}^E v_1, \sigma' \and
       ...
       \endgroup
        ...
        \begin{array}{ccc}
          \inferrule[\textsc{Box}]
                    {e, \rho, \sigma \Downarrow_{pc}^E v, \sigma' \and
                      \alpha \not\in dom(\sigma') \\\\
          ...
          \inferrule[\textsc{Unbox}]
                    ...
                    & 
          \inferrule[\textsc{Set}]
                    {e_1, \rho, \sigma \Downarrow_{pc}^E v_1, \sigma' \and
                     e_2, \rho, \sigma' \Downarrow_{pc}^E v_2, \sigma'' \\\\
        ...
        \inferrule[\textsc{Let-Label}]
          ...
          \inferrule[\textsc{Obs}]
                    {e_1, \rho, \sigma \Downarrow_{pc}^E \sigma', \ell
                      ...
                      e_3, \rho, \sigma''' \Downarrow_{pc}^E \sigma'''', v' \\\\
                      v'' = \fcol{\var{obs}(\ell, pc, v', v^{\pm})}}
                    {(\code{obs} ~ e_1 ~ e_2 ~ e_3), \rho, \sigma \Downarrow_{pc}^E \sigma'''', v''}}
    \end{array}
    \]
    \\
    \hfill \textit{(Possibly-Faceted Application)} \boxed{\fcol{(v ~ v), \rho, \sigma \Downarrow_{pc}^A \sigma, v}}
    \\
    \begingroup
    \color{\colorMATH}
    \begin{displaymath}
